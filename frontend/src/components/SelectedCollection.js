...
const SelectedCollection = (props) => {
    ...
    /* populate the selected collections in main content area */
    // const { selectedCollection, getCollections } = props;
    // useEffect(() => {
    //     getCollections();
    // }, [selectedCollection, getCollections]);
                ...
                <ExpansionPanelDetails>
                    <Typography>
                        {/* {props.selectedCollection.length > 0 &&
                            JSON.stringify(props.selectedCollection)} */}
                        Test
                    </Typography>
                </ExpansionPanelDetails>
            </ExpansionPanel>
